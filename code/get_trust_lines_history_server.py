...
def single_call():
	offset = 0
	url = "https://history.ripple.com/v1/accounts/%s/transactions?type=TrustSet&ledger_min=%d&ledger_max=%d&result=tesSUCCESS&offset=%d" % ("rKMvZZKzwwVRqdbPT2bF6qXueKhxTLNPJa", SMALLEST_LEDGER, BIGGEST_LEDGER, 0)
...
def main():
    ...
    for account in accounts:
        ...
        while 1: # iterate over all the pages for this account
            ...
            url = "https://history.ripple.com/v1/accounts/%s/transactions?type=TrustSet&ledger_min=%d&ledger_max=%d&result=tesSUCCESS&offset=%d" % (account, start_ledger, end_ledger, offset)
